...
class FormValidator {
  ...
  void validateField(
      String field, String? value, String? Function(String?) validator) {
  ...
  // Validação para formulário de login, registro, posts e comentários
  void validateLoginForm(String username, String password) {
    validateField('username', username,
        (value) => ValidationHelper.validateRequired(value, 'Nome de usuário'));
    validateField('password', password,
        (value) => ValidationHelper.validateRequired(value, 'Senha'));
  }
  ...
  void validateRegisterForm(
    ...
    validateField(
        'displayName', displayName, ValidationHelper.validateDisplayName);
  }
